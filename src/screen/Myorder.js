...
export default function MyOrder() {
    ...
    const fetchMyOrder = async () => {
        console.log("orderftrontend",localStorage.getItem('userEmail'))
                                ...
                                data.orderData.order_data.slice(0).reverse().map((item) => {
                                    return (
                                        ...
                                        item.map((arrayData) => {
                                            return (
                                                <div  >
                                                    {arrayData.Order_date ? <div className='m-auto col-12 mt-5 text-center  bg-secondary'>

                                                        <h4 className='p-1'>{data = arrayData.Order_date}</h4>
                                                        <hr />
                                                    </div> :
